    ...
    class Expreso
    {
        ...
        public void load()
        {
            ...
            if (lines > 0 && Variables.run==true)
            {
                ...
                driver.Url = "https://suscripcion.expreso.ec/id/register?continue=https://suscripcion.expreso.ec/suscripcion/SDPEXPRESOPRO";
                Thread.Sleep(1000);
                                ...
                                if (tiempoElemento(By.XPath("//*[@id='message-frame']")))
                                {
                                    ...
                                    if (IsElementPresent(By.XPath("/html/body/div/div[2]/table/tbody/tr[2]/td/table/tbody/tr/td/table[1]/tbody/tr/td/table/tbody/tr/td/table/tbody/tr/td/a")))
                                    {
                                        ...
                                        if (tiempoElemento(By.Id("email")))
                                        {
                                            ...
                                            driver.Navigate().GoToUrl("https://suscripcion.expreso.ec/suscripcion/SDPEXPRESOPRO");
                                            Thread.Sleep(1000);
                ...
                if (lines > 0 && Variables.run==true)
                {
                    if (pagos < 5)
                    {
                        ...
                        if (IsElementPresent(By.XPath("//*[@id='form']/form/div[6]/div[4]/div/div/input")))
                        {
                            ...
                            Thread.Sleep(100);
                            enviarTexto(By.XPath("//*[@id='form']/form/div[6]/div[7]/div/div/input"), "000");
                            Thread.Sleep(500);
                            ...
                            if (ccnum[0].ToString().Trim() == "3")
                            {
                                tipo.SelectByValue("MASTERCARD");
                                Thread.Sleep(500);
                                enviarTexto(By.XPath("//*[@id='form']/form/div[6]/div[7]/div/div/input"), "0");
                                Thread.Sleep(500);
                            }
                            Thread.Sleep(1000);
