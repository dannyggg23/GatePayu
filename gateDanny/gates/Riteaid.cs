            ...
            try
            {
                ...
                if (Thunder._Form1.numcc() > 0 && Variables.run == true)
                {
                    ...
                    if (tiempoElemento(By.XPath("//*[@id='product-addtocart-button']")))
                    {
                        ...
                        if (tiempoElemento(By.XPath("/html/body/div[3]/main/div[2]/div/div[4]/div[2]/div[4]/div[3]/button")))
                        {
                            Thread.Sleep(2000);
                            driver.FindElement(By.XPath("/html/body/div[3]/main/div[2]/div/div[4]/div[2]/div[4]/div[3]/button")).Click();
                        }
                    }
                    else
                    {
                    ...
                    if (tiempoElemento(By.XPath("//*[@id='shipping-new-address-form']/div[1]/div")))
                    {
                        ...
                        Thread.Sleep(2000);
                        var estado = new SelectElement(driver.FindElement(By.Name("region_id")));
