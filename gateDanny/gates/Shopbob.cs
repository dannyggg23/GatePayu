                                                        ...
                                                        if (tiempoElemento(By.Id("select-birthday-month")))
                                                        {
                                                            ...
                                                            if (tiempoElemento(By.XPath("//*[@id='addressBookPage']/a")))
                                                            {
                                                                ...
                                                                if (tiempoElemento(By.Id("addressCountryCode")))
                                                                {
                                                                    ...
                                                                    Thread.Sleep(200);
                                                                    driver.FindElement(By.Id("phoneNumber")).SendKeys("213589" + RandomNumber(1000, 9999));
                                                                    Thread.Sleep(200);
                                                                                ...
                                                                                if (tiempoElemento(By.XPath("//*[@id='add-to-cart-btn']/span[1]")))
                                                                                {
                                                                                    ...
                                                                                    if (tiempoElemento(By.XPath("//*[@id='checkout']")))
                                                                                    {
                                                                                        ...
                                                                                        if (tiempoElemento(By.XPath("//*[@id='checkoutButtonPrimary']")))
                                                                                        {
                                                                                            ...
                                                                                            //driver.Navigate().GoToUrl("https://www.shopbop.com/checkout/payment");
                                                                                            Thread.Sleep(2000);

                                                                                            if (IsElementPresent(By.XPath("/html/body/div[12]/div[1]/div[2]/div[1]/div/div[3]/div[1]/div[1]/div/div[1]/div[4]/div[1]/div/div/div[2]")))
                                                                                            {
