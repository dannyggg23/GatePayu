    ...
    class Overleaf
    {
        ...
        public void load()
        {
            ...
            if (lines > 0)
            {
                ...
                chromeOptions.AddArguments("--window-size=1920,1080", "--blink-settings=imagesEnabled=true", "--incognito");
                ...
                if (tiempoElemento(By.Name("email")))
                {
                    ...
                    Thread.Sleep(500);
                    driver.FindElement(By.XPath("/html/body/div[2]/main/div/form/div[3]/button")).Submit();
                    Thread.Sleep(2000);

                    driver.Navigate().GoToUrl("https://es.overleaf.com/user/subscription/new?planCode=paid-personal_free_trial_7_days&currency=USD&itm_campaign=plans&itm_content=card");
                    Thread.Sleep(2000);
                    pago();
                }
                else
            ...
            try
            {
                ...
                if (lines > 0)
                {
                    if (pagos < 5)
                    {
                        ...
                        driver.FindElement(By.Name("lastName")).SendKeys("REYES");
                        driver.FindElement(By.Name("lastName")).SendKeys("REYES");
